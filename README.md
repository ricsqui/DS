...
* `/advisory` → Branding de clientes de advisory (somente na T2 Holding)
...
│   └── advisory/         ✅ Branding de clientes de advisory (T2 direto)
│       ├── pessoal-saude/
│       └── vila-das-meninas/
├── nexd/                 🔶 Brand pronto · DS a construir
│   └── neura/            🟡 Produto da Nexd · branding próprio (a validar)
...
| Nexd | ✅ Completo (v1.0) | ❌ A construir | ❌ |
...
| Produto | Empresa-mãe | Branding | Skill |
| --- | --- | --- | --- |
| NEURA | Nexd | 🟡 A validar | `neura-brand` |

## Clientes de Advisory (T2 Holding)

A unidade de Advisory entra **direto na Tallent Two** (não sob a Nexd) e carrega o branding da T2.
...
* Produtos ficam aninhados na empresa-mãe (ex.: NEURA sob Nexd)
